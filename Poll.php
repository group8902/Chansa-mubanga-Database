...
<body>
    ...
    <div class="about-content">
        <div class="image-container">
            <img src="images/Citizen-engagement-in-the-delivery-of-social-protection-programmes.png" alt="Citizen Engagement" class="about-image">
    ...
    <div class="about-content reverse">
        ...
        <div class="image-container">
            <img src="images/download.png" alt="Project Updates" class="about-image">
    ...
    <div class="about-content reverse">
        ...
        <div class="image-container">
            <img src="images/vote.png" alt="Voting" class="about-image">
...
<div class="container">
        ...
        <h2>Create Poll</h2>
            ...
            <textarea name="poll_description" placeholder="Poll Description" rows="4" required></textarea>
            <input type="date" name="closing_date" placeholder="Closing Date" required>
    ...
    <p>&copy; 2024 Citizen Participation System. All rights reserved.</p>
        <strong>Zambian Provinces Weather Data</strong><br>
        Designed and Maintained by Chansa Esther Mubanga<br>
        SIN: 2304803007
